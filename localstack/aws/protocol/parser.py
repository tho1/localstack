...
class BaseRestRequestParser(RequestParser):
    def parse(self, request: HttpRequest) -> Tuple[OperationModel, Any]:
        ...
        operation = self.service.operation_model("CreateHostedZone")
        """
        # service-2.json from route53, f.e. CreateHostedZone:
        "CreateHostedZone": {
        ...
        - Parse all operations of the service.
        - Filter by HTTP method
        - Filter by pattern matching on the request URI
        """
        # TODO use the operation to find the input shape
